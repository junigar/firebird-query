...
exports.deleteOneQuery = exports.updateOrInsertQuery = exports.updateOneQuery = exports.insertManyQuery = exports.insertOneQuery = exports.paginatedQuery = exports.sqlBuilder = void 0;
const node_firebird_1 = __importDefault(require("node-firebird"));
const escape = (...val) => node_firebird_1.default.escape(val.join(""));
...
const updateOneQuery = ({ tableName, rowValues, returning = [], where, }) => {
...
const updateOrInsertQuery = ({ tableName, rowValues, returning = [], }) => {
    const columns = Object.keys(rowValues);
    const columnsStr = columns.join(", ");
    const escapedValues = columns.map((key) => escape(rowValues[key]));
    const valuesStr = escapedValues.join(", ");
...
exports.updateOrInsertQuery = updateOrInsertQuery;
const deleteOneQuery = (params) => {
